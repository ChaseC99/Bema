...
const sampleAnnouncement = (
  <AnnouncementCard authorId={1} authorNickname="Test User" date="04-01-2022" id={5} title="Test Announcement" isPublic={true} testId="test-announcement" handleDelete={jest.fn()} handleEdit={jest.fn()}>
